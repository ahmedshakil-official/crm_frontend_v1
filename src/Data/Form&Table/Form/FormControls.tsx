...
export const TooltipInitialValue: FormDataTypes = {
  firstName: "",
  lastName: "",
  username: "",
  city: "",
...
export const BasicFormSubTitle = [
  { text: "Use the", code: `.form-label ` },
  { text: "and", code: `.form-control ` },
  { text: "through create basic form." },
];

export const FloatingFormSubTitle = [
  { text: "Use the", code: `.form-floating` },
...
export const EdgesInputStyleSubTitle = [
  { text: `Give textual form controls like `, code: ` <input>` },
  { text: `s and` },
];
...
export const DefaultCheckBoxSubTitle = [
  { text: `Use the`, code: `.form-check-input  ` },
  { text: `and`, code: `.form-check-label ` },
  { text: "for checkbox." },
];
...
export const ImagesWithCheckBoxSubTitle = [
  { code: `.form-check-input  `, text: `Use the` },
  { text: `and`, code: `.form-check-label ` },
...
export const MultipleInputsSubTitle = [
  { text: "While multiple", code: `<input>` },
];
...
export const PixelstrapSelectList = ["Tivo", "CRM", "Roxo"];
export const FavoriteColorsData = ["Yellow", "Red", "Orange"];
export const FavoriteChocolatesData = [
  "Dark Chocolates",
  "Dairy Milk",
  "Kitkat",
];
...
export const ButtonDropdownData4 = [
  "To-Do",
  "FAQ",
  "Knowledgebase",
  "Support Ticket",
];
export const SegmentedButtonsData1 = [
  "Learning",
  "Editors",
  "Users",
  "Social App",
];
export const SegmentedButtonsData2 = [
  "Search Result",
  "Tasks",
  "Projects",
  "Animation",
...
export const WithoutBorderData = [
  { text: "By adding ", code: ".plain-style " },
