            ...
            <Card className="ecommerce-widget">
              <CardBody className="support-ticket-font pt-2">
                ...
                <Row className="pt-2">
                  <Col xs="12">
                    <span className="pt-1">
                      <strong>Name:</strong> Someone
                    </span>
                    <span className="pt-1">
                      <strong>Email:</strong> dfdjfhjs@gmai.com
                    </span>
                    <span className="pt-1">
                      <strong>Phone:</strong> +8801521545
                    </span>
                  </Col>
                </Row>
            ...
            <Card className="ecommerce-widget">
              <CardBody className="support-ticket-font pt-2">
                ...
                <Row className="pt-2">
                  <Col xs="12">
                    <span className="pt-1">
                      <strong>Case Id:</strong> 45454
                    </span>
                    <span className="pt-1">
                      <strong>Case Category:</strong> Someone
                    </span>
                    <span className="pt-1">
                      <strong>Applicent Type:</strong>{" "}
                      <span className="bg-success px-1 rounded-5">SINGLE</span>
                    </span>
                  </Col>
                </Row>
                <div className="progress-showcase">
              ...
              <CardBody className="support-ticket-font pt-2">
                ...
                <Row className="pt-2">
                  <Col xs="12">
                    ...
                    <span className="pt-1">
                      <strong>Active Status:</strong> <span className="bg-success px-2 rounded-5">Active</span>
                    </span>
                    <span className="pt-1">
