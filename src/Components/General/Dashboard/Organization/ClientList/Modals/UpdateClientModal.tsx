  ...
  return (
    <Modal isOpen={isOpen} toggle={toggle} size="lg">
      <ModalHeader toggle={toggle}>
        <span className="fs-4 text-primary">Update Client</span>
      </ModalHeader>
                ...
                <Col md={6} xs={12}>
                  <FormGroup>
                    ...
                    <Input
                      ...
                      value={clientData.user?.zip_code || ""}
                      onChange={handleChange}
                      className="mb-2"
                    />
                  </FormGroup>
