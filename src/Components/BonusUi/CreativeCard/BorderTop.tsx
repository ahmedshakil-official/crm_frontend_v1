  ...
  return (
    <Col sm="12" md="6">
      <Card className="b-t-0">
        <CommonCardHeader headClass="border-t-danger" title={TopBorder} span={BorderTopData} />
        <CardBody>
          <p className="mb-0">{BorderTopText1}<em className="text-danger">{BorderTopTextEm}</em>{BorderTopText2}</p>
        </CardBody>
      </Card>
    </Col>
  );
