...
const BorderBottom = () => {
  ...
  return (
    <Col sm="12" md="6">
      <Card>
        <CommonCardHeader headClass="border-b-info" title={BottomBorder} span={BorderBottomData} />
        <CardBody>
          <p className="mb-0">{BorderBottomText1}<em className="text-danger">{BorderBottomTextEm}</em>{BorderBottomText2}</p>
        </CardBody>
      </Card>
    </Col>
  );
