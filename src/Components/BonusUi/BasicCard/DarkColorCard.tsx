      ...
      <Card>
        ...
        <CardBody className="bg-dark">
          <div className="d-flex align-items-center gap-3 pills-blogger">
            <div className="blog-wrapper"><Image width={100} height={100} className="blog-img" src={`${ImagePath}/other-images/headphones.png`} alt="head-phone" /></div>
            <div className="blog-content">
              <p><em className="text-danger fw-bold">{SmartHeadphones}</em>{DarkColorText1}</p>
            </div>
          </div>
        </CardBody>
