      ...
      <Card>
        ...
        <CardBody>
          <div className="clipboaard-container">
            ...
            <Input type="textarea" className="custom-scrollbar" rows={1} spellCheck="false" value={clipBoardValues.value} onChange={({ target: { value } }) => setClipBoardValues({ value, copied: false })} />
