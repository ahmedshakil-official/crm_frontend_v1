...
import { AgreeToTermsAndConditions, CRMMail, ContactNumber, Email, EnterFirstName, EnterLastName, EnterNumber, FirstName, LastName, Next, State, ZipCode } from "@/Constant";
      ...
      <Row>
        ...
        <Col xxl="4" sm="6">
          <FormGroup>
            ...
            <Input name="email" type="email" placeholder={CRMMail} value={email} onChange={getUserData} />
          </FormGroup>
        </Col>
        <Col xxl="5" sm="6">
          <FormGroup>
