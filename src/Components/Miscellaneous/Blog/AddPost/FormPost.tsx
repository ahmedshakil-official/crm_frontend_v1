        ...
        <Col sm="12">
          ...
          <FormGroup>
            <div className="col-form-Label">
              {PostCategory}: <Typeahead id="multiple-typeahead" className="mt-2" defaultSelected={PostTypeData} labelKey="name" multiple options={PostTypeData} placeholder={PostTypePlaceholder} />
            </div>
          </FormGroup>
